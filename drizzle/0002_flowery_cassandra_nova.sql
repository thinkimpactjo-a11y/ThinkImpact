...
--> statement-breakpoint
ALTER TABLE "courses" ADD CONSTRAINT "courses_training_id_fkey" FOREIGN KEY ("training_id") REFERENCES "public"."training"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "services" ADD CONSTRAINT "services_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."consulting"("id") ON DELETE no action ON UPDATE no action;